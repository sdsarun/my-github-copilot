...
- Commented-out code blocks (delete, do not leave as comments)
...
- Rename variables/functions whose names do not match their behavior
...
- **Do not add abstractions preemptively** — extract only what has already proven to be duplicated (rule of three).
